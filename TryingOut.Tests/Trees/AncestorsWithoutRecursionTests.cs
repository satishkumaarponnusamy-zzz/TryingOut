...
{
    [TestFixture]
    class AncestorsWithoutRecursionTests
    {
        [Test]
        public void ShouldReturnNullForEmptyTree()
        {
            Ancestors.FindAncestorsWithoutRecursion(null, 0).Should().BeNull();
        }

        [Test]
        public void ShouldReturnNullForWhenKeyIsNotInTree()
        {
            Ancestors.FindAncestorsWithoutRecursion(new Node(5), 0).Should().BeNull();
        }
        ...
        {
            Ancestors.FindAncestorsWithoutRecursion(node, key).Should().ContainInOrder(expectedAncestors);
        }
        ...
        {
            Ancestors.FindAncestorsWithoutRecursion(node, key).Should().BeNull();
        }
        ...
        {
            Ancestors.FindAncestorsWithoutRecursion(node, key).Should().BeEmpty();
        }
    }
}
